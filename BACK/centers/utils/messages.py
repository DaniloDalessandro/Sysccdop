...
REQUESTING_CENTER_MESSAGES = {
    'CREATE_SUCCESS': 'Requesting Center criado com sucesso.',
    'UPDATE_SUCCESS': 'Requesting Center atualizado com sucesso.',
    'DELETE_SUCCESS': 'Requesting Center excluído com sucesso.',
    'NOT_FOUND': 'Requesting Center não encontrado.',
    'INVALID_DATA': 'Os dados fornecidos para o Requesting Center são inválidos.',
